...
public class PreBattleScreen extends JamScreen {
    ...
    public void show() {
        ...
        enemyCell3.setBackground(skin.getDrawable("character-box-empty-10"));
        subTable.add(enemyCell3);
    
        var enemyCell4 = new Table();
        enemyCell4.setBackground(skin.getDrawable("character-box-empty-10"));
        subTable.add(enemyCell4);
    
        var enemyCell5 = new Table();
        enemyCell5.setBackground(skin.getDrawable("character-box-empty-10"));
        subTable.add(enemyCell5);
    
        subTable.row().padTop(20);
        var enemyCell0 = new Table();
        enemyCell0.setBackground(skin.getDrawable("character-box-empty-10"));
        subTable.add(enemyCell0);
    
        var enemyCell1 = new Table();
        enemyCell1.setBackground(skin.getDrawable("character-box-empty-10"));
        subTable.add(enemyCell1);
    
        var enemyCell2 = new Table();
        enemyCell2.setBackground(skin.getDrawable("character-box-empty-10"));
